...
public class DocumentController {
    ...
    public ResponseEntity<StreamingResponseBody> downloadAllDocuments(
        ...
        StreamingResponseBody responseBody =
                outputStream -> documentService.downloadAllDocuments(userPrincipal, outputStream);
    ...
    @PostMapping("/create/awards/sector")
    public ResponseEntity<SuccessResponse<CreateAwardsBySectorRes>> createAwardsBySector(
            @RequestParam Sector sector
    ) {
        CreateAwardsBySectorRes response = documentService.createAwardsBySector(sector);
